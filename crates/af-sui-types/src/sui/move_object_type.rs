...
use crate::{
    COIN_METADATA_STRUCT_NAME, COIN_MODULE_NAME, COIN_STRUCT_NAME, COIN_TREASURE_CAP_NAME,
    DYNAMIC_FIELD_FIELD_STRUCT_NAME, DYNAMIC_FIELD_MODULE_NAME, IdentStr, STAKED_SUI_STRUCT_NAME,
    STAKING_POOL_MODULE_NAME, SUI_FRAMEWORK_ADDRESS, SUI_SYSTEM_ADDRESS,
};
